...
namespaced ID, title, and a query callback. It receives a date-only range and a
bounded snapshot of relative Markdown paths, titles, and leading frontmatter:
...
correspondence, unique paths, and at most 100 notes per date / 1,000 overall.
...
notes. It never interprets dates as timestamps. It requests no general workspace,

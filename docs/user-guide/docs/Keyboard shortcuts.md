...
| Open focused folder context menu | `Shift-F10` or Context Menu key | `Shift-F10` or Context Menu key |
...
cross-pane actions.
Folder and root context menus include project marking. Use the command palette
for whole-vault project actions and unavailable project roots. Active-project
changes are visible in the status bar and announced to screen readers.
